    ...
    <section id="experience" ref={sectionRef}>
        <div className="max-w-6xl mx-auto p-6 lg:ml-24">
            ...
            <div className="text-center mb-12">
                ...
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl">
                ...
                <button
                    onClick={toggleAll}
                    className="absolute -top-2 -right-2 w-10 h-10 bg-white border-2 border-blue-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:border-blue-600 group hover:scale-110"
                    title={showAll ? 'Hide all experiences' : 'Show all experiences'}
                >
                    {showAll ? 
                    <BsEyeSlash className="w-4 h-4 text-blue-500 group-hover:text-blue-600 transition-colors duration-200" /> : 
                    <BsEye className="w-4 h-4 text-blue-500 group-hover:text-blue-600 transition-colors duration-200" />
                    }
                </button>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="absolute left-4 w-8 h-8 bg-white border-4 border-blue-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center hover:border-blue-600 group"
                                    title={isExperienceVisible(exp.id) ? 'Hide details' : 'Show details'}
                                >
                                    {isExperienceVisible(exp.id) ? 
                                    <BsEyeSlash className="w-3 h-3 text-blue-500 group-hover:text-blue-600" /> : 
                                    <BsEye className="w-3 h-3 text-blue-500 group-hover:text-blue-600" />
                                    }
                                </button>
                                
                                {/* Content card */}
                                <div className="ml-20 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                    <div className="p-8">
