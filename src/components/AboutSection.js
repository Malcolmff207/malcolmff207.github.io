// components/AboutSection.js - Updated with dark mode support
...
const AboutSection = () => {
  ...
  return (
    <>
      <section className="pt-20 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300" id="about">
        <div className="lg:ml-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-blue-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-300 leading-relaxed">
                  <p>
                    Hi, I'm <span className="font-semibold text-blue-600 dark:text-blue-400">Malcolm Fenech</span>, a passionate full-stack developer from Malta with a unique background that sets me apart in the tech world.
                  </p>
            ...
            <div className="space-y-8">
              ...
              <div ref={statsRef} className="grid grid-cols-2 gap-4">
                {stats.map((stat, index) => (
                  <div key={index} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-blue-100 dark:border-gray-700 text-center hover:shadow-xl transition-all duration-300 group">
                    ...
                    <div key={index}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {skillGroup.items.map((skill, skillIndex) => (
                          <span 
                            key={skillIndex}
                            className="px-3 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-sm border border-blue-200 dark:border-blue-700 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors duration-200"
                          >
                            {skill}
                          </span>
                        ))}
